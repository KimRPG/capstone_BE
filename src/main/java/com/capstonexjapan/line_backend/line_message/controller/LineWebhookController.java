...
//        }
        ...
        switch (category) {
            case "추천":
                ...
                List<MessageDTO.ProductCardRequest> productList = recommendedProducts.stream().map(product -> {
                    ...
                    productCard.setProductUrl("https://chatgpt.com/c/6724ac66-3768-8002-a0d6-68712cfb459e" + product.getProductId());
                    return productCard;
            ...
            case "배송":
                sendContactButtonMessage(replyToken, "배송 상태가 궁금하신가요?", "배송조회", "https://chatgpt.com/c/6724b2e4-d59c-8002-9849-f86099e66ec2", "+821012345678");
                break;

            case "환불":
                sendContactButtonMessage(replyToken, "환불 정보가 궁금하신가요?", "결제내역", "https://chatgpt.com/c/6724b2e4-d59c-8002-9849-f86099e66ec2", "+821012345678");
                break;

            default:
                sendContactButtonMessage(replyToken, "문의가 필요하시면 아래 버튼을 눌러주세요: " + category, "도움 요청", "https://chatgpt.com/c/6724b2e4-d59c-8002-9849-f86099e66ec2", "+821012345678");
                break;
        }
    }
    ...
    private List<Product> fetchRecommendedProducts(String userMessage) {
        // 임의의 제품 목록 반환
        return List.of(
                new Product(3L, "티셔츠", "https://cf.product-image.s.zigzag.kr/original/c/14/814/588/148145880-1518185832611658513.gif?width=720&height=720&quality=80&format=jpeg", 20000, null, 399, "아식스티셔츠", "아식스", null, new Date(), new Date(), null),
                new Product(4L, "상태 디폴트", "https://cf.product-image.s.zigzag.kr/original/c/14/814/588/148145880-1518185832611658513.gif?width=720&height=720&quality=80&format=jpeg", 10000, ProductStatus.AVAILABLE, 100, "설명", "나이키", null, new Date(), new Date(), null),
                new Product(7L, "as", "https://cf.product-image.s.zigzag.kr/original/c/14/814/588/148145880-1518185832611658513.gif?width=720&height=720&quality=80&format=jpeg", 1200, ProductStatus.AVAILABLE, 400, "asdf", "gd", null, new Date(), new Date(), null),
                new Product(8L, "신라면", "https://cf.product-image.s.zigzag.kr/original/c/14/814/588/148145880-1518185832611658513.gif?width=720&height=720&quality=80&format=jpeg", 1600, ProductStatus.AVAILABLE, 400, "라면임", "농심", null, new Date(), new Date(), null),
                new Product(9L, "신라면", "https://cf.product-image.s.zigzag.kr/original/c/14/814/588/148145880-1518185832611658513.gif?width=720&height=720&quality=80&format=jpeg", 1200, ProductStatus.AVAILABLE, 999808, "라면임", "농심", null, new Date(), new Date(), null)
        );
    }
